...
class HapticsManager {
    ...
    private func playTransientHaptic(intensity: Float, sharpness: Float) {
        ...
        do {
            ...
            print(
                "Failed to play transient haptic: \(error.localizedDescription)"
            )
        }
    }
    ...
    private func playContinuousHaptic(
        ...
        do {
            ...
            print(
                "Failed to play continuous haptic: \(error.localizedDescription)"
            )
        }
    }
    ...
    static func explosion() {
        ...
        let finalSharpnessParam = CHHapticEventParameter(
            parameterID: .hapticSharpness,
            value: 1.0
        )
        ...
        do {
            ...
            print(
                "Failed to play explosion haptic: \(error.localizedDescription)"
            )
        }
    }
    ...
    static func stopPressureHaptics() {
        do {
            ...
            print(
                "Failed to stop pressure haptic: \(error.localizedDescription)"
            )
        }
